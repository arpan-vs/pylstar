...
class TwoWaySwitch(object):
    ...
    def __press_button_a(self):
        ...
        if self._switch_a == 0 and self._switch_b == 0:
            self._switch_a = 1
            return "LIGHT IS ON"
        elif self._switch_a == 1 and self._switch_b == 0:
            self._switch_a = 0
            return "LIGHT IS OFF"
        elif self._switch_a == 0 and self._switch_b == 1:
            self._switch_a = 1
            return "LIGHT IS OFF"
        elif self._switch_a == 1 and self._switch_b == 1:
            self._switch_a = 0
            return "LIGHT IS ON"
